...
public class Map_Facility_To_User2 extends BaseTest {
	...
	public void getOrganizationResourceFacilityID() throws ParseException {
		...
		String facilityName1 = TestDataPropertyReaderAndWriter.getProperty("FacilityName1");
		Object facilityID1 = null;
...
// String resp=response.asString();
		...
		for (Map.Entry<Object, Object> entry : hashmap.entrySet())
			if (entry.getKey().equals(facilityName1)) {
				facilityID1 = entry.getValue();
				break;
			}

		TestDataPropertyReaderAndWriter.setProperty("facilityID1", facilityID1.toString());
	}
	...
	public void PostUserFacilityMapping() throws JSONException {
		...
		obj2.put("facility", TestDataPropertyReaderAndWriter.getProperty("facilityID1"));
