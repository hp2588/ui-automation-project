...
public class CreateItemTest extends BaseTest {
	...
	String itemID1, itemName1, barcode1, productID1;
	
	@Test(priority = 1, description = "VPLX : Item management: System allows to select and save selected Distributor for item.")
	public void Test01_1121557(Method method) {
		...
		test.siteConfigurationAction.clickCheckboxfacilityitemlevel1();
