...
public class ManageVendor {
    ...
    public void createVendor() throws InterruptedException {
        ...
        Map<String, Object> result = Runner.runFeature("classpath:com/bd/data/api/feature/manage_vendor.feature", args, true);
        ...
        for (Entry<String, Object> entry : result.entrySet()) {
            if("vendorKey".equals(entry.getKey())) {
            	...
            	TestDataPropertyReaderAndWriter.setProperty("DistributorName", vendorDesc);
            }
        }
