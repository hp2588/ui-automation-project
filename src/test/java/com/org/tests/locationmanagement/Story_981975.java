...
public class Story_981975 extends BaseTest {
	...
	@Test(priority = 1, description = "VPLX:Location-Storage Area: UI: When user applies the filter, The items are displayed on the basis of Applied Filters on Item Location screen")
	public void Test01_1059503(Method method) {
		ExtentTestManager.startTest(method.getName(),
				"VPLX:Location-Storage Area: UI: When user applies the filter, The items are displayed on the basis of Applied Filters on Item Location screen");
	...
	public void Test04_1059517(Method method) {
		...
		test.siteConfigurationAction.selectValueFromDropDownForFilterItemFields("type", "1",
				"Is");
		test.siteConfigurationAction.selectValueFromDropDownForFilterItemByIndex("filter", "1",1);
		...
		test.siteConfigurationAction.selectValueFromDropDownForMultipleFilterItemFields("field",
				getData("FilterItemsLocation.attribute4"));
