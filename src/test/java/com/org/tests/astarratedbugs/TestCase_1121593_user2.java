...
public class TestCase_1121593_user2 extends BaseTest {
	...
	test.loginPageAction.LoginToTheBDApplication(getData("Auth.userName2").trim(),
	getData("Auth.password2").trim(), getData("Auth.ip").trim());
