...
public class DosageForm_Integration extends BaseTest {
	...
	String itemID, itemName, barcode, productID, itemID1, itemName1, barcode1, productID1, dosageFormCode1;
	...
	@Test(priority = 2, description = "VPLX: Dosage Form: [UI]: [Integration]: Dosage form,which is not mapped to any item is made inactive, then the inactive Dosage form is not displayed in drop-down on Add/Edit Ite")
	public void Test02_1107003(Method method) {
		test.landingPageActions.navigateToFeature("Main Menu");
		test.landingPageActions.navigateToFeature("Dosage Forms");
		test.siteConfigurationAction.selectValueFromDropDown("externalSystems",
				TestDataPropertyReaderAndWriter.getProperty("ExternalSystemName"));
	...
	@Test(priority = 3, description = "VPLX: Item Setup (System and Facility): [UI]:When Generic name or Dosage Form is updated for an item, the updated Item Description gets displayed on Add Pick screen")
	public void Test03_1112409(Method method) {
		test.landingPageActions.navigateToFeature("Main Menu");
	...
	@Test(priority = 4, description = "VPLX: Item Setup (System and Facility): [UI]:When Generic name or Dosage Form is updated for an item, the updated Item Description gets displayed on Add Restock screen")
	public void Test04_1112410(Method method) {
	...
	@Test(priority = 5, description = "VPLX: Item Setup (System and Facility): [UI]:When Generic name or Dosage Form is updated for an item, the updated Item Description gets displayed on Add Return screen")
	public void Test05_1112794(Method method) {
		test.transactionQueueActions.verifyActionButtonAndClick();
	...
	@Test(priority = 6, description = "VPLX: Item Setup (System and Facility): [UI]:When Generic name or Dosage Form is updated for an item, the updated Item Description gets displayed on Location Management screen")
	public void Test06_1112797(Method method) {
		test.landingPageActions.navigateToFeature("Main Menu");
