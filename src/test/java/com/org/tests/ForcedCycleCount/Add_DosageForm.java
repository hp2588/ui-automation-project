...
public class Add_DosageForm extends BaseTest {
	...
	public void Test01_1040230(Method method) {
		...
		test.siteConfigurationAction.selectValueForDropDown("externalSystemKey", TestDataPropertyReaderAndWriter.getProperty("ExternalSystemName_ForcedCC").trim());
		test.supportDataActions.clickButton("save");
		//test.supportDataActions.verifySuccessMessageOnViewPageWithLoader(getData("SuccessMessages.AddHoldReason"));
		TestDataPropertyReaderAndWriter.setProperty("DosageFormDesc_CC", descriptionForm);
		TestDataPropertyReaderAndWriter.setProperty("DosageFormCode_CC", dosageFormCode);
	}
}
