...
public class Map_Facility_To_User6 extends BaseTest {
...
// String resp=response.asString();
	...
	public void getUserID() throws ParseException {
		...
		String userName = getData("Auth.userName7");
		Object userID = null;
		...
		TestDataPropertyReaderAndWriter.setProperty("userID7", userID.toString());
	...
	public void PostUserFacilityMapping() throws JSONException {
		...
		obj.put("userAccount", TestDataPropertyReaderAndWriter.getProperty("userID7"));
		...
		if (response.getStatusCode() == 201) {
			System.out.println(
					"Facility is mapped successfully to user " + getData("Auth.userName7").trim());
