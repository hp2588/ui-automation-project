...
public class CreateDestinationTest extends BaseTest {

	String destinationName1, destinationCode1;
	...
	public void Test02_Add_Destination() {
		...
		destinationName1 = test.siteConfigurationAction.EnterRandomValueInInputFieldOnAddNewPrinterPopup(
				"descriptionText", TestDataPropertyReaderAndWriter.getProperty("FacilityNameReceiving"));
