...
public class Map_Facility_To_User5 extends BaseTest {
...
// String resp=response.asString();
	...
	public void getUserID() throws ParseException {
		...
		String userName = getData("Auth.userName6");
		Object userID = null;
		...
		TestDataPropertyReaderAndWriter.setProperty("userID6", userID.toString());
	...
	public void PostUserFacilityMapping() throws JSONException {
		...
		obj.put("userAccount", TestDataPropertyReaderAndWriter.getProperty("userID6"));
		...
		if (response.getStatusCode() == 201) {
			System.out.println(
					"Facility is mapped successfully to user " + getData("Auth.userName6").trim());
