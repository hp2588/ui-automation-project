...
public class ManageFormulary extends OpaqueAccessToken {
    ...
    public void createFormulary() throws InterruptedException {
        ...
        Map<String, Object> result = Runner.runFeature("classpath:com/bd/data/api/packagesharefeature/manage_formulary.feature", args, true);
    ...
    public void createfacilityFormulary() {
        ...
        TestDataPropertyReaderAndWriter.setProperty("ItemName1", "Warfarin");
    }
}