...
public class Story_115 extends BaseTest {
	 ...
	 * "VPLX: Manage Transaction priorities:[UI] - Create and View a transaction priority"
	 * ) public void Test03_1054082(Method method) {
	 * ExtentTestManager.startTest(method.getName(),
	 * "VPLX: Manage Transaction priorities:[UI] -  Create and View a transaction priority"
	 * ); test.siteConfigurationAction.clickAddItemButtonOnDestinationScreen();
	 * priorityNameReturn =
	 * test.siteConfigurationAction.enterFixedValueInInputField(
	 * "transactionPriorityName", "RETURN"); priorityCodeReturn =
	 * test.siteConfigurationAction.enterFixedValueInInputField(
	 * "transactionPriorityCode", "RETURN");
	 * test.siteConfigurationAction.clickInputButton("colorbutton form-group");
	 * test.siteConfigurationAction.enterRandomValueInInputField("maxHoldMinutes",
	 * "2");
	 * test.siteConfigurationAction.enterRandomValueInInputField("maxLockedSeconds",
	 * "600"); test.siteConfigurationAction.clickCheckboxOfNewRecord();
	 ...
	 * TestDataPropertyReaderAndWriter.setProperty("PriorityNameReturn",
	 * priorityNameReturn);
	 * TestDataPropertyReaderAndWriter.setProperty("priorityCodeReturn",
	 * priorityCodeReturn);
	 * //test.supportDataActions.verifySuccessMessageOnViewPageWithLoader(getData(
	 * "SuccessMessages.AddHoldReason"));
	 * test.supportDataActions.enterSearchTermInSearchFieldGl(priorityNameReturn,
	 * "search"); Assert.assertTrue(test.siteConfigurationAction.
	 * verifySearchResultsOfTransactionPriorities(priorityNameReturn));
	 * TestDataPropertyReaderAndWriter.setProperty("PriorityNameReturn",
	 * priorityNameReturn);
	 * TestDataPropertyReaderAndWriter.setProperty("PriorityCodeReturn",
	 * priorityCodeReturn); }
