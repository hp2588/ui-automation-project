...
public class Create_ISA_Pkg_Shr_Data extends BaseTest {
	...
	ipAddress, portNumber, carouselConnectionResetTime, app_url, resetInterval, name2, name3,shortName1;
	...
	public void Test02_1026541(Method method) throws InterruptedException {
		...
		TestDataPropertyReaderAndWriter.setProperty("ShortName2", shortName1);
	}
