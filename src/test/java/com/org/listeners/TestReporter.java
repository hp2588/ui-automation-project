...
public class TestReporter implements IReporter {
    ...
    protected PrintWriter createWriter(String outdir) throws IOException {
        ...
        return new PrintWriter(new BufferedWriter(new FileWriter(new File(
                outdir, "custom-emailable-report.html"))));
    }
    ...
    protected void writeSuiteSummary() {
        ...
        writer.print("<h2 style=\"text-align:center\">" +"Tenant Name: " + getData("IDM.tenantName") + "</h2>");
        writer.print("<h2 style=\"text-align:center\">" +"Client ID: " + getData("IDM.client_id") + "</h2>");
        writer.print("<table>");
        writer.print("<tr>");
