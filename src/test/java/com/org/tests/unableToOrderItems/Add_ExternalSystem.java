...
public class Add_ExternalSystem extends BaseTest {
	...
	public void Test01_Add_External_System(Method method) throws IOException {
		...
		// test.siteConfigurationAction.clickOnAddButtonToAddParticular("Add External
		// System");
		...
		TestDataPropertyReaderAndWriter.setProperty("ExternalSystemName_UnableToOrder", externalSystem);
