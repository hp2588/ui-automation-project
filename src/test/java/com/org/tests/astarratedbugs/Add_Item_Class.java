...
public class Add_Item_Class extends BaseTest { 

	String itemID, itemName, barcode, productID;

	@Test(priority = 1, description = "VPLX : Drug/Med Class under Item Setup is required field.")
	public void Test01_1121615(Method method) {
