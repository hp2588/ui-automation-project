...
public class RO_1121554 extends BaseTest {

	String OrderName_1, OrderName_2, itemName, FacilityName, DestinationName, ItemCode, DistributorName,
			ExternalSystemName, IPAddress, ISAName, barcode, productID, OrderName1;
	...
	@Test(priority = 1, description = "VPLX : System displays the order summary of remote order when there is one item on the list.")
	public void Test01_1121554(Method method) {
		ExtentTestManager.startTest(method.getName(),"VPLX : System displays the order summary of remote order when there is one item on the list.");
