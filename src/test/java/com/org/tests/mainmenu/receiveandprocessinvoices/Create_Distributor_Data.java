...
public class Create_Distributor_Data extends BaseTest {
	...
	public void Test01_Add_Distributor_Test(Method method) {
		...
		dataEnteredName = test.supportDataActions.enterValueOnMedClassCode_Sanity("descriptionText", "DisManOFF"+System.currentTimeMillis());
		dataEnteredCode = test.supportDataActions.enterValueOnMedClassCode_Sanity("shortCode", "UI"+System.currentTimeMillis());
	...
	public void Test02_Add_Distributor_Test(Method method) {
		...
		test.supportDataActions.clickAddButtonOnDistributor("add");
		dataEnteredName = test.supportDataActions.enterValueOnMedClassCode_Sanity("descriptionText", "DisManON"+System.currentTimeMillis());
		dataEnteredCode = test.supportDataActions.enterValueOnMedClassCode_Sanity("shortCode", "UI"+System.currentTimeMillis());
	...
	public void Test03_Add_Distributor_Test(Method method) {
		...
		dataEnteredName = test.supportDataActions.enterValueOnMedClassCode_Sanity("descriptionText", "DisElecOFF"+System.currentTimeMillis());
		dataEnteredCode = test.supportDataActions.enterValueOnMedClassCode_Sanity("shortCode", "UI"+System.currentTimeMillis());
		test.purchaseDashboardActions.enterDistributorWebsite("vendorContactWebsiteAddressValue","https://www.cardinalhealth.com/");
	...
	public void Test04_Add_Distributor_Test(Method method) {
		...
		test.supportDataActions.clickAddButtonOnDistributor("add");
		test.purchaseDashboardActions.selectRadioButtonElectronicDistributor("electronicDistributorFlag");
		dataEnteredName = test.supportDataActions.enterValueOnMedClassCode_Sanity("descriptionText", "DisElecON"+System.currentTimeMillis());
		dataEnteredCode = test.supportDataActions.enterValueOnMedClassCode_Sanity("shortCode", "UI"+System.currentTimeMillis());
		test.purchaseDashboardActions.enterDistributorWebsite("vendorContactWebsiteAddressValue","https://www.sunpharma.com/");
	...
	public void Test05_Add_Distributor_Test(Method method) {
		...
		test.supportDataActions.clickAddButtonOnDistributor("add");
		dataEnteredName = test.supportDataActions.enterValueOnMedClassCode_Sanity("descriptionText", "Dis2ManOFF"+System.currentTimeMillis());
		dataEnteredCode = test.supportDataActions.enterValueOnMedClassCode_Sanity("shortCode", "UI"+System.currentTimeMillis());
	...
	public void Test06_Add_Distributor_Test(Method method) {
		...
		test.supportDataActions.clickAddButtonOnDistributor("add");
		dataEnteredName = test.supportDataActions.enterValueOnMedClassCode_Sanity("descriptionText", "DistAutoCr"+System.currentTimeMillis());
		dataEnteredCode = test.supportDataActions.enterValueOnMedClassCode_Sanity("shortCode", "UI"+System.currentTimeMillis());
	...
	public void Test07_Map_Distributors_To_Facility(Method method) {
		...
		test.siteConfigurationAction.clickOnEditLinkCorresspondingToFacilityName_Sanity(
		...
		test.siteConfigurationAction.clickOnCheckboxForDistributorToMapWithFacility(TestDataPropertyReaderAndWriter.getProperty("DistributorName1"));
		Assert.assertTrue(test.siteConfigurationAction.enterOnlyIntegerInAccountNumberFieldForSanity(TestDataPropertyReaderAndWriter.getProperty("DistributorName1"), RandomStringUtils.random(6, false, true)));
		
		
		//Manual Distributor 2 Auto Receive OFF
		test.siteConfigurationAction.clickOnCheckboxForDistributorToMapWithFacility(TestDataPropertyReaderAndWriter.getProperty("DistributorName5"));
		Assert.assertTrue(test.siteConfigurationAction.enterOnlyIntegerInAccountNumberFieldForSanity(TestDataPropertyReaderAndWriter.getProperty("DistributorName5"), RandomStringUtils.random(6, false, true)));
		
		//Manual Distributor Auto Receive ON
		test.siteConfigurationAction.clickOnCheckboxForDistributorToMapWithFacility(TestDataPropertyReaderAndWriter.getProperty("DistributorName2"));
		Assert.assertTrue(test.siteConfigurationAction.enterOnlyIntegerInAccountNumberFieldForSanity(TestDataPropertyReaderAndWriter.getProperty("DistributorName2"), RandomStringUtils.random(6, false, true)));
		...
		test.siteConfigurationAction.clickOnCheckboxForDistributorToMapWithFacility(TestDataPropertyReaderAndWriter.getProperty("DistributorName3"));
		Assert.assertTrue(test.siteConfigurationAction.enterOnlyIntegerInAccountNumberFieldForSanity(TestDataPropertyReaderAndWriter.getProperty("DistributorName3"), RandomStringUtils.random(6, false, true)));
		
		//Electronic Distributor Auto Receive ON
		test.siteConfigurationAction.clickOnCheckboxForDistributorToMapWithFacility(TestDataPropertyReaderAndWriter.getProperty("DistributorName4"));
		Assert.assertTrue(test.siteConfigurationAction.enterOnlyIntegerInAccountNumberFieldForSanity(TestDataPropertyReaderAndWriter.getProperty("DistributorName4"), RandomStringUtils.random(6, false, true)));
		test.purchaseDashboardActions.clickCheckboxDistributorOptions(
		...
		test.siteConfigurationAction.clickOnCheckboxForDistributorToMapWithFacility(TestDataPropertyReaderAndWriter.getProperty("AutoCreateDistributor"));
		Assert.assertTrue(test.siteConfigurationAction.enterOnlyIntegerInAccountNumberFieldForSanity(TestDataPropertyReaderAndWriter.getProperty("AutoCreateDistributor"), RandomStringUtils.random(6, false, true)));
		test.purchaseDashboardActions.clickCheckboxDistributorOptions(
