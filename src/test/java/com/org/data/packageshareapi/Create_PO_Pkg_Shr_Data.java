...
public class Create_PO_Pkg_Shr_Data extends BaseTest {
	...
	public void Test02_ProvidingTQ_1115107_1116279_1153574_1153575(Method method) {
		...
		test.storageAreaAction.selectPrinterForSelectedISA(TestDataPropertyReaderAndWriter.getProperty("PrinterNameProviding"));
	...
	public void Test03_ReceivingTQ_1124854(Method method) {
		...
		test.storageAreaAction.selectPrinterForSelectedISA(TestDataPropertyReaderAndWriter.getProperty("PrinterNameReceiving"));
