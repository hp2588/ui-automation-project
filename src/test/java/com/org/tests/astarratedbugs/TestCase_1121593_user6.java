...
public class TestCase_1121593_user6 extends BaseTest {
	...
	test.loginPageAction.LoginToTheBDApplication(getData("Auth.userName6").trim(),
	getData("Auth.password6").trim(), getData("Auth.ip").trim());
