...
public class Create_MedItem_Pkg_Shr_Data extends BaseTest { 
	...
	//	test.supportDataActions.verifySuccessMessageOnViewPageWithLoader(getData("SuccessMessages.AddHoldReason"));
		...
		/*
		 * test.supportDataActions.enterSearchTermInSearchField(itemID1, "search");
		 * 
		 ...
		 * test.siteConfigurationAction.clickOnADMRoundingQuantityFlag(
		 * "admQuantityRoundingFlag");
		 * test.siteConfigurationAction.enterCostValue("averageWholesalePriceAmount",
		 * "10");
		 * //test.siteConfigurationAction.enterCostValue("averageSalesPriceAmount",
		 * "10"); test.siteConfigurationAction.verifyAndClickProductID("Product ID");
		 ...
		 * 
		 * test.supportDataActions.clickOnEditLinkCorresspondingToItem(itemID1);
		 * test.siteConfigurationAction.verifyAndClickItemFacility1(
