...
public class IntISATest extends BaseTest {
	...
	public void Test01_AddISA(Method method) throws InterruptedException {
	...
	public void Test02_AddISA(Method method) throws InterruptedException {
		...
		TestDataPropertyReaderAndWriter.setProperty("ISAName1", name);
	}
}
