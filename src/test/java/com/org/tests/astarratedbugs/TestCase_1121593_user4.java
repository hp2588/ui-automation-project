...
public class TestCase_1121593_user4 extends BaseTest {
	...
	test.loginPageAction.LoginToTheBDApplication(getData("Auth.userName4").trim(),
	getData("Auth.password4").trim(), getData("Auth.ip").trim());
