package com.org.automation.tokengenerator;
...
public class OpaqueAccessToken_SupportUser extends BaseTest {
	...
	private void getOpaqueToken() {
		...
		TestDataPropertyReaderAndWriter.setProperty("opaque_access_token", opaqueAccessToken);
	}
