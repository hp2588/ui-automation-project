...
public class ManagePrinter {
    ...
    public void createPrinter() {
        ...
        Map<String, Object> result = Runner.runFeature("classpath:com/bd/data/api/feature/manage_printer.feature", args, true);

        for (Entry<String, Object> entry : result.entrySet()) {
            if("printerKey".equals(entry.getKey())) {
            	printerKey = (String) entry.getValue();                
                TestDataPropertyReaderAndWriter.setProperty("PrinterKey", printerKey);
            }
