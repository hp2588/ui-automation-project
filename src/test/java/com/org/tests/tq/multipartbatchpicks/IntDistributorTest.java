...
public class IntDistributorTest extends BaseTest {
	...
	public void Test01_Add_Distributor_Test(Method method) {
		...
		dataEnteredName = test.supportDataActions.enterValueOnMedClassCode_Sanity("descriptionText", "dis"+System.currentTimeMillis());
		...
		test.siteConfigurationAction.clickCheckboxBatchTransactionPriorities(TestDataPropertyReaderAndWriter.getProperty("PriorityName"));
		test.siteConfigurationAction.clickCheckboxAutoReleasTransactionPriorities(TestDataPropertyReaderAndWriter.getProperty("PriorityName"));
		...
		Assert.assertTrue(test.siteConfigurationAction.enterOnlyIntegerInAccountNumberFieldForSanity(TestDataPropertyReaderAndWriter.getProperty("DistributorName").trim(),"12345"));
