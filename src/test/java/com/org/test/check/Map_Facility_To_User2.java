...
// String resp=response.asString();
	...
	public void getUserID() throws ParseException {
		...
		String userName = getData("Auth.userName3");
		Object userID = null;
		...
		TestDataPropertyReaderAndWriter.setProperty("userID3", userID.toString());
	...
	public void PostUserFacilityMapping() throws JSONException {
		...
		obj.put("userAccount", TestDataPropertyReaderAndWriter.getProperty("userID3"));
		...
		if (response.getStatusCode() == 201) {
			System.out.println(
					"Facility is mapped successfully to user " + getData("Auth.userName3").trim());
