...
public class TestCase_1121593_user5 extends BaseTest {
	...
	test.loginPageAction.LoginToTheBDApplication(getData("Auth.userName5").trim(),
	getData("Auth.password5").trim(), getData("Auth.ip").trim());
