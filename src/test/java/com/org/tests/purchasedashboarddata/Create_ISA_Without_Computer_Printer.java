...
public class Create_ISA_Without_Computer_Printer extends BaseTest {
	...
	public void Test01_1026541(Method method) throws InterruptedException {
		 ...
		 * test.siteConfigurationAction.selectValueForDropDown(
		 * "logisticsLabelPrinterKey",
		...
		/*
		 * if (!(test.storageAreaAction.verifyCheckboxIsCheckedApprovedComputer(
		 * "restrictControlFlag"))) {
		 * test.storageAreaAction.clickCheckboxTransactionPriorities(
		 * "restrictControlFlag"); Assert.assertTrue(test.storageAreaAction.
		 * verifyCheckboxIsCheckedApprovedComputer("restrictControlFlag")); }
		 * test.storageAreaAction.clickButtonOnApprovedComputerPage("Add");
		 * test.storageAreaAction.
		 * verifyApprovedComputerPopupPage("Add Approved Computer"); String
		 * ComputerStatic =
