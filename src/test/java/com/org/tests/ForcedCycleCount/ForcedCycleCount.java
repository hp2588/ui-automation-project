...
public class ForcedCycleCount extends BaseTest {
		...
		
		{
			...
			test.supportDataActions.clickOnEditLinkCorresspondingToItemNew(TestDataPropertyReaderAndWriter.getProperty("FacilityName_ForcedCC"));
		...
		
		{
			...
			test.siteConfigurationAction.enterExternalSystemValueDropdownField(TestDataPropertyReaderAndWriter.getProperty("ExternalSystemName_ForcedCC").trim());
		...
		//	test.siteConfigurationAction.selectValueFromDropDownByIndex("dispensingUnitKey", 1);
			...
			test.supportDataActions.clickOnEditLinkCorresspondingToItemNew(genericname[i]);
