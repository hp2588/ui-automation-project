...
public class Add_MedicationClass extends BaseTest{
	...
	public void Test02_MedicationClass_Test(Method method) {
		...
		test.siteConfigurationAction.selectDropdownDispenseExternal(
				TestDataPropertyReaderAndWriter.getProperty("ExternalSystemName"), "medication");
		...
		dataEnteredCode = test.supportDataActions.enterValueOnMedClassCode_Sanity("medicationClassCode", 
				"2" + "-" + DateUtil.generateRandomDigits(8));
