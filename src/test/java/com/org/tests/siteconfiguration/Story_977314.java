...
public class Story_977314 extends BaseTest {
	...
	@Test(priority = 4, description = "VPLX:Manage ISAs:[UI] -IP address field is mandatory and editable under Display settings")
	public void Test04_1033540(Method method) throws Throwable {
	...
	@Test(priority = 5, description = "VPLX:Manage ISAs:[UI] - Port Number field is mandatory and editable under Display settings")
	public void Test05_1033542(Method method) throws Throwable {
	...
	@Test(priority = 6, description = "VPLX:Manage ISAs:[UI] - Display type field is mandatory and user is able to select from dropdown box")
	public void Test06_1033544(Method method) throws Throwable {
		...
		// test.siteConfigurationAction.selectValueForDropDown("ticBarDisplayTypeKey",
		// "White TIC Bar");

	}

	@Test(priority = 7, description = "VPLX:Manage ISAs:[UI] -Columns per inch field is non mandatory and editable under Display Settings tab")
	public void Test07_1033547(Method method) throws Throwable {
	...
	@Test(priority = 10, description = "VPLX:Manage ISAs:[UI] -Display type ,IP Address and Port fields gets disabled when Light display is not handled by ISA controller is unchecked")
	public void Test10_1034102(Method method) throws Throwable {

		ExtentTestManager.startTest(method.getName(),
				"VPLX:Manage ISAs:[UI] -Display type ,IP Address and Port fields gets disabled when Light display is not handled by ISA controller is unchecked");
	...
	@Test(priority = 8, description = "VPLX:Manage ISAs:[UI] -Simple bin light display (not a tic bar) is unchecked by default")
	public void Test08_1034086(Method method) throws Throwable {
	...
	@Test(priority = 9, description = "VPLX:Manage ISAs:[UI] -Display type ,IP Address and Port fields gets enabled when Light display is not handled by ISA controller is checked")
	public void Test09_1034101(Method method) throws Throwable {
