...
public class LabelTags_Integration extends BaseTest {
	...
	public void Test01_1110226(Method method) {
		...
		System.out.println("LABEL TAG NAME ::: " + dataEnteredCode);
	...
	@Test(priority = 3, description = "VPLX: Label Tags [UI]: After deleting a Label Tag "
			+ "it is no longer visible in Item Management Add/Edit Items Label Tags drop down")
