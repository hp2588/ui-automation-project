...
public class Story_119  extends BaseTest {
	...
	String priority, location;
	 ...
	 @Test(priority = 1, description = "VPLX:Manual Pick[UI]-Verify Add Return Transaction")
		public void Test01_1016370(Method method)
		{
			...
			//location=test.transactionQueueActions.selectDropdownForAddPick("Returned From",TestDataPropertyReaderAndWriter.getProperty("DestinationName").trim());
			//test.siteConfigurationAction.selectValueForDropDown("sourceLocation", TestDataPropertyReaderAndWriter.getProperty("DestinationName").trim());
