...
String dataEnteredCode, dataEnteredDescription, dataEnteredSort, external_System;
	...
	public void Test02_MedicationClass_Test(Method method) {
		...
		test.siteConfigurationAction.selectDropdownDispenseExternal(TestDataPropertyReaderAndWriter.getProperty("ExternalSystemName_ForcedCC"), "medication");
		...
		TestDataPropertyReaderAndWriter.setProperty("MedClassCode_CC", dataEnteredCode);
